...
export default function InteractivePortrait() {
  ...
  useEffect(() => {
    ...
    const bgPlaneMaterial = new THREE.MeshBasicMaterial({ color: 0x0a0a0a, transparent: true })
    ...
    bgPlaneMaterial.onBeforeCompile = (shader) => {
      ...
      `.replace(
        ...
        // 1. Define as cores - dark theme matching Lando style
        vec3 colorBg = vec3(0.04);
        vec3 colorSoftShape = vec3(0.08);
        vec3 colorLine = vec3(0.12);
  ...
  return (
    <div
      ref={containerRef}
      className="fixed inset-0 w-full h-full bg-lorenzo-dark cursor-crosshair overflow-hidden"
