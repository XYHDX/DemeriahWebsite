...
function TimeUnit({ value, label }: { value: number; label: string }) {
  return (
    <div className="flex flex-row items-baseline">
      <span className="font-oswald font-bold text-[5rem] md:text-[8rem] lg:text-[12rem] text-white leading-none tracking-tighter tabular-nums uppercase stretch-125">
        {value.toString().padStart(2, "0")}
      </span>
      <span className="font-oswald font-bold text-[5rem] md:text-[8rem] lg:text-[12rem] text-white/30 leading-none tracking-tighter uppercase stretch-125 ml-1">
        {label}
      </span>
    </div>
  )
