...
export default function RiderTechSection() {
  ...
  return (
    <section id="tech-specs" className="relative min-h-screen bg-lorenzo-dark px-6 md:px-12 overflow-visible py-0 mb-0 pb-24">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8 md:mb-12">
          <h2 className="text-5xl md:text-7xl lg:text-8xl font-black uppercase tracking-tight leading-tight">
            <span className="block font-sans leading-[0.85] text-white">TECH</span>
            <span className="block font-brier text-white text-9xl">SPECS</span>
          </h2>
          <p className="text-base mt-6 max-w-2xl text-white/70 md:text-base">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <div className="md:hidden text-center mt-8 text-white/50 text-sm">
