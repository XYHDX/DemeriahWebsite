...
export default function TestimonialSection() {
  return (
    <section className="relative min-h-screen bg-lorenzo-dark overflow-hidden flex items-center">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-lorenzo-dark/80 via-lorenzo-dark/90 to-lorenzo-dark" />
      </div>
